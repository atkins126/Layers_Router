...
type
  TLayers_RouterSwitch = class(TInterfacedObject, ILayers_RouterSwitch)
    ...
    public
      ...
      function Router(APath : String; ARouter : TPersistentClass; ASidebarKey : String = 'SBIndex'; IsVisible :
        Boolean = True) : ILayers_RouterSwitch;
...
function TLayers_RouterSwitch.Router(APath : String; ARouter : TPersistentClass; ASidebarKey : String = 'SBIndex'; IsVisible : Boolean = True) : ILayers_RouterSwitch;
begin
  Result := Self;
...
function TLayers_RouterSwitch.SideBarList: TDictionary<String, ILayers_RouterSidebars>;
begin
  Result := FSideBarList;
end;
