...
type
  ...
  var
    ...
    procedure Subscribe(ASubscriber: TObject; ASubscriberMethod: TSubscriber_Method);
  ...
  public
    ...
    property SubscriptionsOfGivenEventType: TObjectDictionary < TClass, TObjectList < TSubscription >> read FSubscriptionsOfGivenEventType;
...
begin
  ...
  try
    ...
    LSubscriberMethods := TSubscribers_Finder.FindSubscriberMethods
...
procedure TEvent_Bus.Subscribe(ASubscriber: TObject;
