...
type
  ...
  ILayers_RouterComponentForm = interface
    ['{86DC13C3-BE7E-48D3-A510-86FD7A1590B9}']
    {$IFDEF HAS_FMX}
    function Render : TFMXObject;
    {$ElSE}
    function Rend: TForm; overload;
    {$ENDIF}
    procedure UnRender;
  end;

  ILayers_RouterComponentFrame = interface
    ['{721FB51D-BCF5-4CE4-9083-9BE397FEC099}']
    {$IFDEF HAS_FMX}
    function Render : TFMXObject;
    {$ElSE}
    function Rend: TForm; overload;
  ...
  ILayers_RouterLink = interface
    ...
    function &Throw ( APatch : String; ANameContainer : String) : ILayers_RouterLink; overload;
  ...
  ILayers_RouterSwitch = interface
    ...
    function Router(APath : String; aRouter : TPersistentClass; ASidebarKey : String = 'SBIndex'; IsVisible : Boolean = True) : ILayers_RouterSwitch;
