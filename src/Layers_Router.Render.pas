...
{$IFDEF HAS_FMX}
function TLayers_RouterRender.SetElement( AComponent : TFMXObject; AIndexComponent : TFMXObject = nil ) : ILayers_RouterRender;
begin
  Result := Self;
...
function TLayers_RouterRender.SetElement( AComponent : TPanel; AIndexComponent : TPanel = nil ) : ILayers_RouterRender;
begin
  Result := Self;
...
class function TLayers_RouterRender.New(
  Parent: ILayers_RouterComponent): ILayers_RouterRender;
begin
